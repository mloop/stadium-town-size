...
df %>%
  ...
  select(conference, football_stadium_capacity, municipality_population, distance_nearest_emergency_department_miles, is_closest_ed_free_standing, acc_accreditation_or_certification, closest_ed_number_beds, teaching_hospital_in_municipality, cluster) %>%
